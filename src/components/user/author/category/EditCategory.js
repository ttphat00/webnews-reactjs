                ...
                <div className="row justify-content-center">
                    <div className="col-md-5">
                        <div className="my-table-post">
                            <div className="my-card-header"><b>CHỈNH SỬA CHỦ ĐỀ</b> {isShow ? <button type="submit" className="btn btn-light" onClick={clickBack}><i className="fa fa-undo" aria-hidden="true"></i></button> : null}</div>
