                ...
                <div className="row justify-content-center">
                    <div className="col-md-10">
                        <div className="my-table-cate">
                            <div className="my-card-header"><b>CHỦ ĐỀ ĐÃ DUYỆT</b></div>
                            <div className="card-body">
                                ...
                                <nav aria-label="Page navigation example">
                                    <ul className="pagination">
                                        <li className="page-item"><Link className="page-link" to={'/admin/approved-category/'+(id > 1 ? (parseInt(id) - 1) : 1)}>&laquo;</Link></li>
                                        {
                                            sumCate.map((data, index) => {
                                                if( index < (sumCate.length/5) ){
                                                    return(
                                                        <li key={index} className="page-item"><Link className="page-link" to={'/admin/approved-category/'+(index + 1)}>{index + 1}</Link></li>
                                                    );
                                                }else return null;
                                            })
                                        }
                                        <li className="page-item"><Link className="page-link" to={'/admin/approved-category/'+(id < (sumCate.length/5) ? (parseInt(id) + 1) : id)}>&raquo;</Link></li>
                                    </ul>
                                </nav>
                            </div>
                        </div>
